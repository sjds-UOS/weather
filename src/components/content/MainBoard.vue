<template>
  <div class="main-board">
    <div class="update-time">
      <span @click="updateBtn" style="-webkit-app-region:no-drag">
    ...
    <div class="weather-board">
      ...
      <div>
        <span style="font-size: 20px;cursor: pointer; -webkit-app-region:no-drag" @click="changetoweeks">
          未来14天天气预报
        </span>
      </div>
    </div>
